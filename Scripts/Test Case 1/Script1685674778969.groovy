...
WebUI.click(findTestObject('Object Repository/Page_Connect2Clinic/div_My Account'))

WebUI.click(findTestObject('Object Repository/Page_Connect2Clinic/a_Logout'))
